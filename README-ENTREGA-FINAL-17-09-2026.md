...
MELHOR_ENVIO_CALLBACK_URL=https://relppscos.netlify.app/melhor-envio-callback.html
...
`https://relppscos.netlify.app/.netlify/functions/bling-webhook-background`
...
`https://relppscos.netlify.app/api/health`

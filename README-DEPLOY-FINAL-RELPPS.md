...
Domínio configurado: `https://relppscosmeticooo.netlify.app`
...
3. No aplicativo do Bling, o callback deve ser exatamente `https://relppscosmeticooo.netlify.app/bling-callback.html`.
4. Abra `https://relppscosmeticooo.netlify.app/api/health` para verificar o preflight.

...
Domínio configurado: `https://relppscos.netlify.app`
...
3. No aplicativo do Bling, o callback deve ser exatamente `https://relppscos.netlify.app/bling-callback.html`.
4. Abra `https://relppscos.netlify.app/api/health` para verificar o preflight.

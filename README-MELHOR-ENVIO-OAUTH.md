...
2. Configure `MELHOR_ENVIO_CALLBACK_URL` exatamente como: `https://relppscosmeticooo.netlify.app/melhor-envio-callback.html`.
3. Execute o SQL que cria `relpps_melhor_envio_oauth` no Supabase.
4. Abra `https://relppscosmeticooo.netlify.app/api/shipping?action=authorize`.

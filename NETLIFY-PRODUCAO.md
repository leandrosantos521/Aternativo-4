...
`https://relppscosmeticooo.netlify.app/.netlify/functions/checkout?action=infinitepay-webhook`
...
Abra `https://relppscosmeticooo.netlify.app/api/health`.
...
3. Abra `https://relppscosmeticooo.netlify.app/homologacao-bling.html`.

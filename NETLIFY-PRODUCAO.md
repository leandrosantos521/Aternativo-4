...
`https://relppscos.netlify.app/.netlify/functions/checkout?action=infinitepay-webhook`
...
Abra `https://relppscos.netlify.app/api/health`.
...
3. Abra `https://relppscos.netlify.app/homologacao-bling.html`.
